...
<body>
        ...
        <div class="authentication-inner">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Vui Lòng Nhập Mã Để Thay Đổi Mật Khẩu</p>
              <form id="form_forgot_password" class="mb-3">
                <div class="mb-3">
  ...
  <script>
    $(document).ready(function () {
        var email_forgot_password = sessionStorage.getItem('email_forgot_password');
        ...
        if (email_forgot_password !== null) {
            var textContent = "Vui lòng kiểm tra email và nhập mã";
            showToast(textContent, 'success');
            sessionStorage.removeItem('email_forgot_password');
        }
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.errors) {
                        ...
                        sessionStorage.setItem('confim-forgot-code', 'done');
                        window.location.href = '{{route("show_new_password") }}';
                    }
                },
