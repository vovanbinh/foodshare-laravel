...
<div class="row bg-white" style="border-radius: 0.5rem;">
  ...
  <div class="col-md-8 text-start">
    ...
    <div class="col-md-12">
        ...
        <form id="form_collect_food">
        @csrf
        <div class="row">
          <div class="col-md-3 pt-2 text-info">
            <strong>Số Lượng Nhận:</strong>
          </div>
          <input hidden name="id" value="{{$foodData['id']}}">
          <div class="col-md-9">
            <div class="row">
              <div class="col-1 text-end" style="padding-right:0; padding-left:0;" >
                <button style="padding:6px; border-radius: 3px 0 0 3px;" type="button" 
                data-field="food-quantity" data-type="minus" 
                id="minus" class="btn btn-info btn-lg btn-number">
                  -
                </button>
              </div>
              <div class="col-2" style="padding-left:0; padding-right:0;" >
                <input type="number" value="1" min="1" class="form-control text-center" id="food-quantity" name="food_quantity" style="border-radius: 0">
              </div>
              <div class="col-2" style="padding-left:0;" >
                <button data-field="food-quantity" data-type="plus" 
                style="padding:6px; border-radius: 0 3px 3px 0;" type="button" id="plus" 
                class="btn-number btn btn-info btn-lg">+</button>
              </div>
            </div>
          </div>
        </div>
        <div class="row text-end mt-3 mb-5" style="padding-left:0.8em">
          <button type="submit" id="btn_collect_food" class="btn btn-success col-3 "style="min-width:200px;">Nhận Thực Phẩm</button>
        </div>
        </form>
