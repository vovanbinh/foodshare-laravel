        ...
        <div class="authentication-inner">
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">Vui Lòng Nhập Gmail Để Thay Đổi Mật Khẩu</p>
            ...
            $.ajax({
                ...
                success: function (response) { 
                    if (response.errors) {
                        ...
                        sessionStorage.setItem('email_forgot_password', 'done');
                        window.location.href = '{{route("show_confirm_code_forgot") }}';
                    }
                },
